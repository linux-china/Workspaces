...
public final class Icons {
    ...
    public static final Icon ADD_WORKSPACE = AllIcons.General.Add;
    public static final Icon REMOVE_WORKSPACE = AllIcons.General.Remove;

    public static final Icon CONFIGURE_WORKSPACE = AllIcons.Actions.Properties;
